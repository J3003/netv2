...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210414_jakobwordpress_89199f7aa1c761467124_20210414103324_archive.zip';
	const ARCHIVE_SIZE		 = '71983955';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '89199f7-14103324';
    const SECONDARY_PACKAGE_HASH = '379de5f-14103324';
	const VERSION			 = '1.4.0';
